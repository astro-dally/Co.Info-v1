...
import { Building2, Newspaper, BarChart3 } from "lucide-react"
...
export default function EmptyState() {
  ...
  const handleExampleSearch = (symbol: string) => {
  ...
  return (
    <div className="mt-16 flex flex-col items-center justify-center text-center">
      ...
      <p className="text-gray-600 dark:text-gray-300 max-w-lg mb-8 text-lg">
        Enter a company name or ticker symbol in the search bar above to view company information, recent news, and
        financial data.
      </p>
...
const features = [
  ...
  },
  {
    ...
    description: "View key financial metrics including stock price, market cap, and performance indicators.",
  },
]
